...
(function () {
  ...
  const DICT = {
    en: {
      ...
      'pricing.sub': 'The core tools are free forever. Unlock the power features once for £4.99 — no subscription.',
      ...
      'pricing.pro.perk1': 'Hold-Space window shortcuts',
      'pricing.pro.perk2': 'Screen & window recording',
      'pricing.pro.perk3': 'Built-in clip editor',
      'pricing.pro.perk4': 'Snap-to-element screenshots',
      'pricing.pro.perk5': 'Automatic updates',
    ...
    fr: {
      ...
      'pricing.pro.perk1': 'Raccourcis de fenêtres avec Espace',
      'pricing.pro.perk2': "Enregistrement d'écran et de fenêtre",
      'pricing.pro.perk3': 'Éditeur de clips intégré',
      'pricing.pro.perk4': 'Captures avec accroche aux éléments',
      'pricing.pro.perk5': 'Mises à jour automatiques',
    ...
    de: {
      ...
      'pricing.pro.perk1': 'Fenster-Kürzel mit Leertaste',
      'pricing.pro.perk2': 'Bildschirm- und Fensteraufnahme',
      'pricing.pro.perk3': 'Integrierter Clip-Editor',
      'pricing.pro.perk4': 'Screenshots mit Element-Andocken',
      'pricing.pro.perk5': 'Automatische Updates',
    ...
    zh: {
      ...
      'pricing.pro.perk1': '长按空格的窗口快捷键',
      'pricing.pro.perk2': '屏幕与窗口录制',
      'pricing.pro.perk3': '内置视频剪辑',
      'pricing.pro.perk4': '截图自动贴边吸附',
      'pricing.pro.perk5': '自动更新',
    ...
    es: {
      ...
      'pricing.pro.perk1': 'Atajos de ventanas con Espacio',
      'pricing.pro.perk2': 'Grabación de pantalla y ventana',
      'pricing.pro.perk3': 'Editor de clips integrado',
      'pricing.pro.perk4': 'Capturas con ajuste a elementos',
      'pricing.pro.perk5': 'Actualizaciones automáticas',
    ...
    ru: {
      ...
      'pricing.pro.perk1': 'Оконные горячие клавиши с пробелом',
      'pricing.pro.perk2': 'Запись экрана и окна',
      'pricing.pro.perk3': 'Встроенный редактор клипов',
      'pricing.pro.perk4': 'Скриншоты с привязкой к элементам',
      'pricing.pro.perk5': 'Автоматические обновления',
